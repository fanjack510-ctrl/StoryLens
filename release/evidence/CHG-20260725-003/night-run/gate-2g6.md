...
Structure Empty Policy WIP: untouched
Push / Tag / Release / verified: NO
Formal user DB: not accessed
```
...
| Path | `create_all` + `apply_narrative_migrations` x2 |
...
| License / Native Overview gated when flag off | PASSED (walking/flag suites; no Live) |
...
Windows 1.1.0 release-candidate validation
