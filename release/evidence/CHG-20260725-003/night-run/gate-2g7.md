...
Step：STEP 2.7
Gate：STEP 2.G7
Started�?026-07-26T10:42:13+08:00
Finished�?026-07-26T11:30:00+08:00 (approx; final smoke after rebuild)
```

## HEADs / governance

```text
Public HEAD (at G7 close)�?filled by commit after evidence>
Private HEAD�?8072775773a09f4dc849096ba314e4fa0487c58

Formal VERSION�?.0.5 (restored after RC override; never permanently changed)
RC Version�?.1.0-rc.1
...
```text
Build Commands�?  .\scripts\build_windows_rc.ps1
...
Installer Path�?  D:\Dstorylens-wt-narrative-phase2br1-integration\dist\release\StoryLens_1.1.0-rc.1_x64-setup.exe
Installer Size�?2065357 bytes
Installer SHA-256�?873BC614558221CFD9E3D89B0DBCBB8028C5AA393C202F009D48945C0956013

Build log�?  release/evidence/CHG-20260725-003/night-run/windows-build-log.md
```
...
```text
Install Test：Sidecar EXE isolated smoke (project smoke_windows_release + smoke_windows_rc_2g7); full NSIS GUI install deferred to STEP 2.8 human acceptance
